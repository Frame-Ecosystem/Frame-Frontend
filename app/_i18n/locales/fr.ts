...
const fr: Record<string, string> = {
  ...
  "content.reel.durationError": "La durée doit être comprise entre 1 et 300 secondes.",
  ...
  "content.post.imageSizeError": "Un ou plusieurs fichiers dépassent la limite de taille.",
  "content.error.uploadFileTooLarge": "Un ou plusieurs fichiers dépassent la limite de taille.",
