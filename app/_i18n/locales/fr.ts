...
const fr: Record<string, string> = {
  ...
  "auth.signin.checkingSession": "Vérification d'une session existante...",
  "auth.signin.dontHaveAccount": "Pas de compte ?",
  "auth.signin.signup": "Inscrivez-vous",
  ...
  "content.reel.durationError":
    "La durée doit être comprise entre 1 et 300 secondes.",
  "content.reel.thumbnailOptional": "Miniature personnalisée (optionnel)",
  "content.post.mediaLimitError": "Vous pouvez téléverser jusqu'à 20 images.",
  ...
  "admin.nav.extras": "Extras",
  "admin.nav.extrasDesc": "Gérer le catalogue global des extras",
  ...
  "admin.extras.desc": "Gérer le catalogue global des extras",
  "admin.extras.addExtra": "Ajouter un extra",
  "admin.extras.noExtras": "Aucun extra",
  "admin.extras.addFirst": "Ajoutez votre premier extra au catalogue",
  "admin.extras.headerName": "Nom",
  "admin.extras.headerCategory": "Catégorie",
  "admin.extras.headerDescription": "Description",
  "admin.extras.headerCost": "Coût",
  "admin.extras.headerStatus": "Statut",
  "admin.extras.editExtra": "Modifier l'extra",
  "admin.extras.deleteConfirm": "Supprimer l'extra ?",
  "admin.extras.saving": "Enregistrement...",
  "admin.extras.create": "Créer",
  "admin.extras.searchPlaceholder": "Rechercher des extras...",
  "admin.extras.trySearch": "Essayez un autre terme de recherche",
  "admin.extras.free": "Gratuit",
  "admin.extras.paid": "Payant",
  "admin.extras.cost": "Coût",
  "admin.extras.freeLabel": "Gratuit",
  "admin.extras.price": "Prix",
  "admin.extras.category": "Catégorie",
  "admin.extras.isActive": "Actif",
  "admin.extras.description": "Description",

  // ── Lounge Extras ──────────────────────────────────────────────────────
  "loungeExtras.title": "Extras",
  "loungeExtras.subtitle": "Gérer les extras adoptés par votre salon",
  "loungeExtras.adoptExtra": "Adopter un extra",
  "loungeExtras.noExtras": "Aucun extra adopté pour le moment",
  "loungeExtras.addFirst":
    "Parcourez les extras disponibles et adoptez-les pour votre salon",
  "loungeExtras.headerName": "Nom",
  "loungeExtras.headerDescription": "Description",
  "loungeExtras.headerCost": "Coût",
  "loungeExtras.headerStatus": "Statut",
  "loungeExtras.searchPlaceholder": "Rechercher des extras...",
  "loungeExtras.trySearch": "Essayez un autre terme de recherche",
  "loungeExtras.free": "Gratuit",
  "loungeExtras.paid": "Payant",
  "loungeExtras.available": "Extras disponibles",
  "loungeExtras.myExtras": "Mes extras",
  "loungeExtras.active": "Actif",
  "loungeExtras.inactive": "Inactif",
  "loungeExtras.adopted": "Adopté",
  "loungeExtras.adopt": "Adopter",
  "loungeExtras.remove": "Retirer",
  "loungeExtras.toggleActive": "Changer le statut",
  "loungeExtras.adoptConfirmTitle": "Adopter un extra",
  "loungeExtras.adoptConfirmDesc":
    "Êtes-vous sûr de vouloir adopter cet extra ?",
  "loungeExtras.removeConfirmTitle": "Retirer un extra",
  "loungeExtras.removeConfirmDesc": 'Retirer "{name}" de vos extras ?',
  "loungeExtras.adoptedSuccess": "Extra adopté avec succès",
  "loungeExtras.removedSuccess": "Extra retiré avec succès",
  "loungeExtras.toggleSuccess": "Statut de l'extra modifié",
  "loungeExtras.cost": "Coût",
  "loungeExtras.description": "Description",
  "loungeExtras.browseAvailable": "Parcourir les extras disponibles",
  "loungeExtras.backToMyExtras": "Retour à mes extras",
  "loungeExtras.backToService": "Retour à la gestion des services",
  "loungeExtras.adoptedExtras": "Extras adoptés",
  "loungeExtras.all": "Tout",
  "loungeExtras.manage": "Gérer les extras",
